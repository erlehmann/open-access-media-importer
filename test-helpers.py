...
class TestEfetch(unittest.TestCase):
    ...
    def test_get_categories_from_pmid(self):
        ...
        for category in \
                ['Behavior, Animal', 'Calcium', 'Drosophila melanogaster',
                 'Embryo, Nonmammalian', 'Feedback, Sensory', 'Larva',
                 'Locomotion', 'Motor Neurons', 'Muscle Contraction',
                 'Nerve Net', 'Sensation', 'Sense Organs', 'Time Factors']:
